      ...
      headers: myHeaders,
       ...
       fetch("https://api.affinda.com/v2/resumes",
        ...
        console.log("filtered data",skillsDataArray)
            ...
            const city = [result][0].data.location?[result][0].data.location.city:null;
            const state = [result][0].data.location ? [result][0].data.location.state : null;
            const postalCode = [result][0].data.location ? [result][0].data.location.postalCode :null;
            const country = [result][0].data.location? [result][0].data.location.country :null;
